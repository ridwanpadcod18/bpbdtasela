...
<head>
  ...
  <title>SISTEM INFORMASI | BPBD TASELA</title>
...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/images.jpeg');?>')no-repeat;background-size:100%;">
<div class="login-box">
  	<br/>
  <div class="login-logo">
    <a href="index.php" style="color: black;">Sistem Informasi <br/><b>BPBD TASELA</b></a>
  </div>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: yellow;"> E-BPBD TASELA<?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
