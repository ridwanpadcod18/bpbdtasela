                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label>Status</label>
                                    <br/>
                                    <input type="radio" name="jenkel" <?php if($user->jenkel == 'Siaga'){ echo 'checked';}?> value="Siaga" required="required"> Siaga
                                    <br/>
                                    <input type="radio" name="jenkel" <?php if($user->jenkel == 'Waspada'){ echo 'checked';}?> value="Waspada" required="required"> Waspada
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
